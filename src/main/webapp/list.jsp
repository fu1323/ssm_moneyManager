            ...
            <%--<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>--%>
                ...
                <head>
                    <%-- <script src="js/color-modes.js"></script>--%>
                        <% if (request.getSession().getAttribute("user")==null) {
                            ...
                            <link rel="icon" href="js/favicon.png" type="image/png">
                ...
                <%--<body>--%>
                    ...
                    <script>
                        ...
                        let offsetX, offsetY;
                        let dumplicate = function (name, price, date, comment, counte2) {
                            // alert($("#adderclickbtn"))
                            if (!main) {
                                adder($("#adderclickbtn")[0], name, dateTool(new Date(date).toLocaleDateString()), price, comment, new Date(counte2).toLocaleDateString())
                        ...
                        let dom = function (b) {
                            ...
                            for (let i = 0; i < b.length; i++) {
                                ...
                                var htmlTableRowElement1a = document.createElement("a")

                                var ele = document.createElement("td");
                                // $(ele).
                                $(htmlTableRowElement1a).text(a)
                                if (!main) {
                                    $(htmlTableRowElement1a).attr("href", "javascript:void(0)")
                                }
                                a++;
                                $(ele).append(htmlTableRowElement1a)
                                ...
                                $(htmlTableRowElement1a).click(function () {
                                    dumplicate(b[i].name, b[i].price, b[i].date, b[i].comment, b[i].countTo)
                                })
                                ...
                                htmlInputElement.scrollIntoView({
                                    behavior: 'smooth', // 平滑滚动，可用 'auto' 立即跳转
                                    block: 'center',    // 元素在视口垂直方向的位置：'start' | 'center' | 'end' | 'nearest'
                                    inline: 'end'   // 水平方向定位
                                });
                    ...
                    <main>
                            ...
                            <header class="d-flex justify-content-center py-3">
                                <div>
                                    <ul class="nav nav-pills">
                                        <li class="nav-item"><a href="/list.jsp" class="nav-link active"
                                                aria-current="page" id="mainp">主表</a></li>
                                        <li class="nav-item"><a href="#" class="nav-link" id="fu">副表</a></li>
                                        <input type="button" value="退出系统" id="exit"
                                            style="color: crimson;display: inline-block;" name="12e3">
                                    </ul>
                                </div>

                            </header>
                        </div>
                        <div style=" float: right;margin-right:10%" id="list01">
                            <div style="float: left;margin: 8px;">
                                <div style="white-space: nowrap">

                                    <a class="btn btn-primary" href="javascript:void(0)" onclick="func()">隐藏/显示</a>
                                    <a class="btn btn-primary" href="/goldku.jsp">金库总表</a>

                                    <a class="btn btn-primary" href="javascript:void(0)" id="monetPX"
                                        onclick="jin_e()">按金额排序</a>
                                    <br>
                        ...
                        <div style="display: block;margin-left:10%;">
                            <div class="nav-item" style="display: inline;"><a href="#" class="nav-link" id="up"
                                    style="font-size: small;color: #bcccc7;">调整月份(日期随意)</a>
                            ...
                            <input type="button" id="dateok" value="提交" name="dateok" style="display: inline-block"
                                onclick="set(this)">
                            <input type="button" value="清除" id="clr" name="123" style="display: inline-block;">
                    ...
                    <h3 style="display: block ;text-align: center" id="titled">6月份收支统计主表</h3>
                    <div class="container">
                        ...
                        <div id="draggable" style="left: 1173.0625px; top: 164.457031px;">
                            <table class="table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td id="tuodongid" hidden="hidden">19</td>
                                        <td id="zongkaizhi">612.95</td>
                                        <td id="yu_e" style="background: red;">-612</td>
                                    </tr>
                                </tbody>
                        ...
                        <script>
                            ...
                            let tuodongAjax = function () {
                                $.ajax({
                                    url: "/monthlyall/select?year=" + year + "&month=" + month,
                                    type: "get",
                        ...
                        <form id="form" method="post">
                            <table border="1" class="table table-bordered table-hover" style="float: left;margin: 8px;"
                                id="abc" width="500px">
                                <caption>
                                </caption>
                                ...
                                <tbody id="tbd">
                                    <tr id="trbtn">
                                        <td colspan="5" align="center" id="addbtn"><input name="add" type="button"
                                                value="添加" id="adderclickbtn" onclick="adder(this)"></td>
                                    </tr>
                                </tbody>
