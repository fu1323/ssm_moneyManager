                            ...
                            <header class="d-flex justify-content-center py-3">
                                <div>
                                    <ul class="nav nav-pills">
                                        <li class="nav-item"><a href="${pageContext.request.contextPath}/list.jsp"
                                                class="nav-link active" aria-current="page" id="mainp">主表</a></li>
                                        <li class="nav-item"><a href="#" class="nav-link" <%--onclick="fu(this)" --%>
                                                id="fu">副表</a></li> 
                                ...
                                <div style="display: block;">
                                    <div class="nav-item" style="display: inline;"><a href="#" class="nav-link" id="up"
                                        ...
                                        <input type="date" id="da" name="da" style="display: inline-block"></div>
                                
                                    <input type="button" id="dateok" value="提交" name="dateok"
                                        style="display: inline-block" onclick="set(this)">
                        ...
                        <div style=" float: left;" id="list01">
                            <div style="float: left;margin: 8px;">
                                <div style="white-space: nowrap">
                                    ...
                                    <a class="btn btn-primary" href="${pageContext.request.contextPath}/goldku.jsp"
                                        <%--onclick="add()--%>>金库总表</a>
                <%--                <a class=" btn btn-primary" href="javascript:void(0)" id="create"
                                        onclick="createZuHe()">创建组合</a>--%>
                                    <a class="btn btn-primary" href="javascript:void(0)" id="monetPX"
                                        onclick="jin_e()">按金额排序</a>
                                    <br>
<h3 style="display: inline-block;margin-left: 80% ;text-align: center"
                                        id="titled"> 统计</h3>
                        ...
                        <body>
                            ...
                            <form id="form" method="post">
                                <table border="1" class="table table-bordered table-hover"
                                    style="float: left;margin: 8px;" id="abc" width="500px">
<caption>   
                                    </caption>
